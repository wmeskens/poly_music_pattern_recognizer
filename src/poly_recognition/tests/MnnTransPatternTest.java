...
public class MnnTransPatternTest {
	private MnnTransPattern basePat;
	private MnnTransPattern pat1;
	...
	public void setUp() throws Exception {
		...
		patvals2.add(dif23);
		patvals2.add(dif24);
		pat1 = new MnnTransPattern(patvals1,new ArrayList<Occurrence>(),basePat);
	...
	public void splitTest() {
		...
		MnnTransPattern genPat = (MnnTransPattern)genPats.get(0);
	...
	public void exactResultsTest(){
		...
		Analyser an = new MnnTransAnalyser(file);
		an.analyse();
