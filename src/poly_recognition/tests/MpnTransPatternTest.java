...
public class MpnTransPatternTest {
	private MpnTransPattern basePat;
	private MpnTransPattern pat1;
	...
	public void setUp() throws Exception {
		...
		patvals2.add(dif23);
		patvals2.add(dif24);
		pat1 = new MpnTransPattern(patvals1,new ArrayList<Occurrence>(),basePat);
	...
	public void splitTest() {
		...
		MpnTransPattern genPat = (MpnTransPattern)genPats.get(0);
	...
	public void exactResultsTest(){
		...
		Analyser an = new MpnTransAnalyser(file);
		an.analyse();
